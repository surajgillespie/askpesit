...
<?=$form->checkbox('CSIS', array('hiddenField' => false));?>CS AND IS<br>
<?=$form->checkbox('ECTE', array('hiddenField' => false));?>EC AND TE<br>
<?=$form->checkbox('MECH', array('hiddenField' => false));?>MECHANICAL<br>
<?=$form->checkbox('ELECT', array('hiddenField' => false));?>ELECTRICAL<br>
<?=$form->checkbox('BIOT', array('hiddenField' => false));?>BIOTECH<br>
<?=$form->checkbox('SANDH', array('hiddenField' => false));?>SCIENCE AND HUMANITIES<br>
<?=$form->checkbox('MATH', array('hiddenField' => false));?>MATHEMATICS<br>
<?=$form->checkbox('PESIT', array('hiddenField' => false));?>PESIT<br>
<?=$form->checkbox('PESITEVENTS', array('hiddenField' => false));?>PESIT EVENTS<br>
<?=$form->label('tags');?><br/>
