...
<head>
	...
	<title><?=$title_for_layout;?> | AskPESIT</title>
	<?=$html->css('screen.css');?>
			...
			<ul class="tabs">
				...
				<li>
					...
					<ul>
						...
						<li>
							<?=$html->link(ucfirst(__('Suggestions',true)),
							array('controller' => 'suggestions', 'action' => 'index')
							);
							?>
						</li>
					</ul>
	...
	<div class="wrapper">
        <a href="<?=$this->webroot; ?>"><?php echo $html->image('logo.png', array('alt' => 'Logo', 'id' => 'logo')); ?></a>
		  ...
		  <ul class="tabs">
		    ...
		    <li><?=$html->link(__('Polls',true),'/polls');?></li>
		    <li><?=$html->link(__('Advanced search',true),'/questions/subjects');?></li>
			...
			<li><?=$html->link(__('Top 5',true),'/users/top');?></li>
		  </ul>
		  <ul class="tabs" style="float: right;">
			<li>
				<?=$html->link(
						__('Create a poll',true),
						array('controller' => 'polls', 'action' => 'create')
					);
				?>
			</li>
			<li>
  ...
  <div id="body" class="wrapper">
    ...
    <div id="sidebar" class="wrapper">
		...
		<? if(isset($admin) && $admin) { ?>
			<a href="/askpesit/widgets/edit/<?=$widget['Widget']['id'];?>" title="Edit this Widget"><?php __('edit'); ?></a>	| 
			<a href="/askpesit/widgets/delete/<?=$widget['Widget']['id'];?>" title="Delete Widget"><?php __('del'); ?></a>	
		<? } ?>
		  </div>
		<?
		}
	    ...
	    if(isset($admin) && $admin):
    ?>
        <a href="/askpesit/widgets/add<?php echo $_SERVER['REQUEST_URI']; ?>">
            <img src="/askpesit/app/webroot/img/icons/plugin_edit.png" alt="Edit"/><?php __('add widgets to this page'); ?>.
        </a>
        <? endif; ?>
  ...
  <div id="footer" class="wrapper">
    ...
    <ul class="tabs">
      ...
      <?=$html->link(__('about',true),'/about');?></li>
        <li>
      <?=$html->link(__('suggestions',true),'/suggestions/add');?></li>
    </ul>

	</div>
	<?php
		echo $this->element('pesit');
	?>
  </div>
